...
\usepackage{tikz}
\usetikzlibrary{positioning, shapes, backgrounds, patterns}
\usepackage{amsmath}
\usepackage{graphicx}
\usepackage{lipsum}
\usepackage{geometry}
...
\begin{titlepage}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        % Background Grid
        \fill[pattern=checkerboard, pattern color=secondary!50] (current page.south west) rectangle (current page.north east);
